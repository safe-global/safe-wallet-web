...
export const GOERLI_SAFE_APPS_SAFE =
  "gor:0x168ca275d1103cb0a30980813140053c7566932F";
export const GOERLI_TEST_SAFE =
  "gor:0x97d314157727D517A706B5D08507A1f9B44AaaE9";
// SEPOLIA_TEST_SAFE_1 should always have no transactions, tokens and NFTs
export const SEPOLIA_TEST_SAFE_1 =
  "sep:0xBb26E3717172d5000F87DeFd391994f789D80aEB";
...
export const SEPOLIA_TEST_SAFE_2 =
  "sep:0x33C4AA5729D91FfB3B87AEf8a324bb6304Fb905c";
export const SEPOLIA_TEST_SAFE_3 =
...
export const SEPOLIA_TEST_SAFE_5 =
  "sep:0xBd69b0a9DC90eB6F9bAc3E4a5875f437348b6415";
export const SEPOLIA_TEST_SAFE_6 =
  "sep:0x6d0b6F96f665Bb4490f9ddb2e450Da2f7e546dC1";
// SAFE_7 has ENS assigned to it
export const SEPOLIA_TEST_SAFE_7 =
  "sep:0xBf30F749FC027a5d79c4710D988F0D3C8e217A4F";
// SAFE 8 is used for tx history tests
export const SEPOLIA_TEST_SAFE_8 =
  "sep:0x5912f6616c84024cD1aff0D5b55bb36F5180fFdb";
// SAFE 9 & 10 are used for safe apps tests
export const SEPOLIA_TEST_SAFE_9 =
  "sep:0xD1571E8Cc4438aFef2836DD9a0E5D09fb63EDE9a";
export const SEPOLIA_TEST_SAFE_10 =
  "sep:0x4DD4cB2299E491E1B469245DB589ccB2B16d7bde";
// SAFE 11 is used for remove owner tests
export const SEPOLIA_TEST_SAFE_11 =
  "sep:0x81034C61a318649F7aD43f9e8C1051427e326443";
// SAFE 12 is used for spending limits
export const SEPOLIA_TEST_SAFE_12 =
  "sep:0x9190cc22D592dDcf396Fa616ce84a9978fD96Fc9";
// SAFE 13 & 14 are used for sidebar with pending tx, no further tx should be made in it
export const SEPOLIA_TEST_SAFE_13 =
  "sep:0x98705770aF3b18db0a64597F6d4DCe825915fec0";
export const SEPOLIA_TEST_SAFE_13_SHORT = "0x9870...fec0";
export const SEPOLIA_TEST_SAFE_14 =
  "sep:0xC23e061252BFc7967203D054136d8fA7c7df2fc4";
// SAFE 15 is a safe with native tokens but the automation user is not its owner
export const SEPOLIA_TEST_SAFE_15_TOKEN =
  "sep:0xfC0A7ac73Fde7547ac0792Cca1D8A50CE0AFC4Df";
export const SEPOLIA_TEST_SAFE_16_CREATE_TX =
  "sep:0xc2F3645bfd395516d1a18CA6ad9298299d328C01";
export const SEPOLIA_TEST_SAFE_17_SIDEBAR_NONOWNER =
  "sep:0x10B45a24640E2170B6AA63ea3A289D723a0C9cba";
export const SEPOLIA_TEST_SAFE_18_PENDING_TX =
  "sep:0xFFfaC243A24EecE6553f0Da278322aCF1Fb6CeF1";
export const SEPOLIA_TEST_SAFE_19_NONOWNER_NFT =
  "sep:0x3e259dea1E317743Cb49CA9358904E07420ff061";
...
export const PAGINATION_TEST_SAFE =
  "gor:0x850493a15914aAC05a821A3FAb973b4598889A7b";
...
export const SPENDING_LIMIT_ADDRESS_2 =
  "0x52835f11E348605E9D791Ec09380a3224526d538";
...
export const WRONGLY_CHECKSUMMED_ADDRESS =
