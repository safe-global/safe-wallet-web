...
const CONFIG_SERVICE_CHAINS: ChainInfo[] = [
  ...
  },
  {
    ...
    l2: true,
    description: 'L2 chain (MATIC)',
    rpcUri: { authentication: RPC_AUTHENTICATION.API_KEY_PATH, value: 'https://babel-nightly.iotex.io/' },
    safeAppsRpcUri: { authentication: RPC_AUTHENTICATION.API_KEY_PATH, value: 'https://babel-nightly.iotex.io/' },
    publicRpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://babel-nightly.iotex.io/' },
    blockExplorerUriTemplate: {
      address: 'https://iotexscan.io/address/{{address}}',
      txHash: 'https://iotexscan.io/tx/{{txHash}}',
      api: 'https://api.iotexscan.io/api?module={{module}}&action={{action}}&address={{address}}&apiKey={{apiKey}}',
    },
    nativeCurrency: {
      name: 'IOTX',
      symbol: 'IOTX',
      decimals: 18,
      logoUri:
        'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/icon/iotx.svg',
    },
    theme: { textColor: '#ffffff', backgroundColor: '#00d4d5' },
    gasPrice: [{ type: GAS_PRICE_TYPE.FIXED, weiValue: '1000000000000' }],
    disabledWallets: [
      'authereum',
      'fortmatic',
      'keystone',
