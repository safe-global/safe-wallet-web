...
const EmptyBatch = ({ children }: { children: ReactNode }) => (
  <Box data-sid="79622" display="flex" flexWrap="wrap" justifyContent="center" textAlign="center" mt={3} px={4}>
