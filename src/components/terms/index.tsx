  ...
  return (
    <div>
      ...
      <p>
        ...
        browser extension&nbsp;(each a &ldquo;{'Safe App'}&rdquo;). The {'Safe App'} may be used to manage your personal
      ...
      <p>
        ...
        Third-Party&nbsp;{'Safe Apps'} are integrated in the user interface of the {'Safe App'} via inline framing. The
        provider of the Third-Party&nbsp;{'Safe App'} and related Third-Party Service is responsible for the operation
        of the service and the correctness, completeness and actuality of any information provided therein. We make a
        pre-selection of Third-Party&nbsp;{'Safe Apps'} that we show in the {'Safe App'}. However, we only perform a
        rough triage in advance for obvious problems and functionality in terms of loading time and resolution
