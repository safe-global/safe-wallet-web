...
const SafeTerms = () => {
  return (
    <div>
      ...
      <p>
        &ldquo;Safe&rdquo; is a modular, self-custodial (i.e. not supervised by us) smart contract-based wallet not
        provided by CC. Safes are{' '}
      ...
      <p>
        ...
        on Ethereum and other common EVM chains when you connect the Safe with third-party&nbsp;services (as defined
