...
import css from '@/components/signedMessages/MsgSigners/styles.module.css'
...
const shouldHideConfirmations = (msg: SignedMessage): boolean => {
...
export const MsgSigners = ({ msg }: { msg: SignedMessage }): ReactElement => {
