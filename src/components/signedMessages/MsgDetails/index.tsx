...
import MsgSigners from '@/components/signedMessages/MsgSigners'
...
import Msg from '@/components/signedMessages/Msg'
...
const MsgDetails = ({ msg }: { msg: SignedMessage }): ReactElement => {
