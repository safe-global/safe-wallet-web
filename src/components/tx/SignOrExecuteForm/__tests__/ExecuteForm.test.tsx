...
describe('ExecuteForm', () => {
  ...
  it('shows a non-owner error if the transaction still needs signatures and its not an owner', () => {
    ...
    expect(
      getByText("You are currently not an signer of this Safe Account and won't be able to submit this transaction."),
    ).toBeInTheDocument()
  })
  ...
  it('does not show a non-owner error if the transaction is fully signed and its not an owner', () => {
    ...
    expect(
      queryByText("You are currently not an signer of this Safe Account and won't be able to submit this transaction."),
