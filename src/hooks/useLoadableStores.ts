...
import useLoadMessages from './loadables/useLoadMessages'
...
import { signedMessagesSlice } from '@/store/signedMessagesSlice'
...
const useLoadableStores = () => {
  ...
  useUpdateStore(signedMessagesSlice, useLoadMessages)
