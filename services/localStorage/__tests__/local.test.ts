...
describe('local storage', () => {
  ...
  describe('getItem', () => {
    it('returns a parsed value', () => {
      ...
      window.localStorage.setItem('_SAFE__test', stringifiedValue)
  ...
  describe('setItem', () => {
    it('saves a stringified value', () => {
      ...
      expect(window.localStorage.getItem('_SAFE__test')).toBe('true')
    })
  })
  ...
  describe('handling undefined', () => {
    it('saves ands reads undefined', () => {
      ...
      expect(window.localStorage.getItem('_SAFE__test_undefined')).toBe('undefined')
    })
  })
})
