...
export type StreamAndHistoryQuery = {
  __typename?: 'Query'
  user?: {
    __typename?: 'User'
    streams: Array<{
      ...
      contract: { __typename?: 'LlamaPayContract'; address: any }
      payer: { __typename?: 'User'; id: string }
      payee: { __typename?: 'User'; id: string }
      token: { __typename?: 'Token'; address: any; name: string; decimals: number; symbol: string }
      historicalEvents: Array<{ __typename?: 'HistoryEvent'; eventType: string; txHash: any; createdTimestamp: any }>
    }>
    historicalEvents: Array<{
      ...
      oldStream?: {
        ...
        payer: { __typename?: 'User'; id: string }
        payee: { __typename?: 'User'; id: string }
        token: { __typename?: 'Token'; address: any; symbol: string }
      } | null
...
export type UserStreamFragment = {
  __typename?: 'Stream'
  streamId: any
  active: boolean
  reason?: string | null
...
export type UserHistoryFragment = {
  __typename?: 'HistoryEvent'
  txHash: any
  eventType: string
  amount?: any | null
...
export const useStreamAndHistoryQuery = <TData = StreamAndHistoryQuery, TError = unknown>(
  ...
  useQuery<StreamAndHistoryQuery, TError, TData>(
    ...
    fetcher<StreamAndHistoryQuery, StreamAndHistoryQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      StreamAndHistoryDocument,
      variables,
    ),
    options,
  )
...
export const StreamByIdDocument = `
  ...
  streams(where: {streamId: $id}) {
    ...
    ${UserStreamFragmentDoc}`
export const useStreamByIdQuery = <TData = StreamByIdQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  ...
  useQuery<StreamByIdQuery, TError, TData>(
    ...
    fetcher<StreamByIdQuery, StreamByIdQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      StreamByIdDocument,
      variables,
